...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerecord>, ["~> 5.2.0.rc"])
      s.add_runtime_dependency(%q<railties>, ["~> 5.2.0.rc" ])
    else
      s.add_dependency(%q<rake>, [">= 10.0"])
      s.add_dependency(%q<activerecord>, ["~> 5.2.0.rc"])
      s.add_dependency(%q<railties>, ["~> 5.2.0.rc"])
    end
  else
    s.add_dependency(%q<rake>, [">= 10.0"])
    s.add_dependency(%q<activerecord>, ["~> 5.2.0.rc"])
